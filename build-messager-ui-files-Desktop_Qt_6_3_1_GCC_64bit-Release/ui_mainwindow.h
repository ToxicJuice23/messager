...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridLayout_4->setContentsMargins(0, 0, 0, 5);
        message_input = new QLineEdit(Homepage);
        message_input->setObjectName(QString::fromUtf8("message_input"));
        message_input->setStyleSheet(QString::fromUtf8("background-color: white; border: 1px solid black;"));

        gridLayout_4->addWidget(message_input, 3, 1, 1, 1);
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 438, 504));
        gridLayout = new QGridLayout(scrollAreaWidgetContents);
        gridLayout->setSpacing(0);
        gridLayout->setObjectName(QString::fromUtf8("gridLayout"));
        gridLayout->setContentsMargins(0, 0, 0, 0);
        messages_container = new QLabel(scrollAreaWidgetContents);
        messages_container->setObjectName(QString::fromUtf8("messages_container"));
        messages_container->setStyleSheet(QString::fromUtf8("padding: 5px;"));
        messages_container->setAlignment(Qt::AlignBottom|Qt::AlignLeading|Qt::AlignLeft);

        gridLayout->addWidget(messages_container, 1, 0, 1, 3);

        scrollArea_2->setWidget(scrollAreaWidgetContents);

        gridLayout_4->addWidget(scrollArea_2, 1, 1, 2, 2);

        send_message = new QPushButton(Homepage);
        send_message->setObjectName(QString::fromUtf8("send_message"));
        QFont font1;
        font1.setPointSize(10);
        send_message->setFont(font1);
        send_message->setStyleSheet(QString::fromUtf8("text-align: center; background-color: #74bd20;"));

        gridLayout_4->addWidget(send_message, 3, 2, 1, 1);

        contact_button = new QPushButton(Homepage);
        contact_button->setObjectName(QString::fromUtf8("contact_button"));
        contact_button->setStyleSheet(QString::fromUtf8("text-align: c; border: 0; padding: 10px; background-color: #74bd20;"));

        gridLayout_4->addWidget(contact_button, 0, 1, 1, 2);
        ...
        conversations->setGeometry(QRect(0, 0, 360, 290));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        messages_container->setText(QString());
        send_message->setText(QCoreApplication::translate("MainWindow", "Envoyer", nullptr));
        contact_button->setText(QCoreApplication::translate("MainWindow", "PushButton", nullptr));
    } // retranslateUi
